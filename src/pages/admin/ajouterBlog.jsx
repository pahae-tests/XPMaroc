...
export default function AdminBlogPublisher() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const base64 = formData.img ? await convertToBase64(formData.img) : null;
      setLoading(true);
      setMessage({ type: '', text: '' });
      ...
      if (response.ok) {
        ...
        setMessage({ type: 'error', text: data.message || 'Failed to publish blog' });
      }
    } catch (error) {
      console.error('Error publishing blog:', error);
      setMessage({ type: 'error', text: 'An error occurred while publishing the blog' });
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Share your stories and insights with the world
          </p>
        </div>
